       ...
       tableView.separatorStyle = UITableViewCellSeparatorStyle.none
        ...
        dbRef = Database.database().reference()
            ...
            if currentController == "track"{
                ...
                dbHandle = dbRef.child("Track").child(userUID).observe(.childAdded, with: { (Track_Snap) in
           ...
           if self.grading == "ALL"{
            ...
            if Track_Value ["Grade"] == self.grading{
                ...
                dbHandle = dbRef.child("Flo").child(userUID).observe(.childAdded, with: { (Track_Snap) in
